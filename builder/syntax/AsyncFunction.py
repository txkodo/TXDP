...
from builder.context.scopes import AsyncContextScope, AsyncRecursiveContextScope
...
class AsyncMcfunction(Generic[X]):
    ...
    @overload
    def __call__(self: AsyncMcfunction[Literal[True]], func: Callable[[], None]) -> AsyncRecursiveMcfunctionDef[None]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[], Assign[R0]]
    ) -> AsyncRecursiveMcfunctionDef[R0]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[], tuple[Assign[R0], Assign[R1]]]
    ) -> AsyncRecursiveMcfunctionDef[tuple[R0, R1]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[], tuple[Assign[R0], Assign[R1], Assign[R2]]]
    ) -> AsyncRecursiveMcfunctionDef[tuple[R0, R1, R2]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[], tuple[Assign[R0], Assign[R1], Assign[R2], Assign[R3]]]
    ) -> AsyncRecursiveMcfunctionDef[tuple[R0, R1, R2, R3]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0], None]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], None]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0], Assign[R0]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], R0]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0], tuple[Assign[R0], Assign[R1]]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], tuple[R0, R1]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0], tuple[Assign[R0], Assign[R1], Assign[R2]]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], tuple[R0, R1, R2]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]],
        func: Callable[[P0], tuple[Assign[R0], Assign[R1], Assign[R2], Assign[R3]]],
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], tuple[R0, R1, R2, R3]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1], None]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], None]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1], Assign[R0]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], R0]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1], tuple[Assign[R0], Assign[R1]]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], tuple[R0, R1]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1], tuple[Assign[R0], Assign[R1], Assign[R2]]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], tuple[R0, R1, R2]]:
        pass
    ...
    def __call__(
        self: AsyncMcfunction[Literal[True]],
        func: Callable[[P0, P1], tuple[Assign[R0], Assign[R1], Assign[R2], Assign[R3]]],
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], tuple[R0, R1, R2, R3]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1, P2], None]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], None]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1, P2], Assign[R0]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], R0]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1, P2], tuple[Assign[R0], Assign[R1]]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], tuple[R0, R1]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1, P2], tuple[Assign[R0], Assign[R1], Assign[R2]]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], tuple[R0, R1, R2]]:
        pass
    ...
    def __call__(
        self: AsyncMcfunction[Literal[True]],
        func: Callable[[P0, P1, P2], tuple[Assign[R0], Assign[R1], Assign[R2], Assign[R3]]],
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], tuple[R0, R1, R2, R3]]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1, P2, P3], None]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], Assign[P3], None]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1, P2, P3], Assign[R0]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], Assign[P3], R0]:
        pass
    ...
    @overload
    def __call__(
        self: AsyncMcfunction[Literal[True]], func: Callable[[P0, P1, P2, P3], tuple[Assign[R0], Assign[R1]]]
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], Assign[P3], tuple[R0, R1]]:
        pass
    ...
    def __call__(
        self: AsyncMcfunction[Literal[True]],
        func: Callable[[P0, P1, P2, P3], tuple[Assign[R0], Assign[R1], Assign[R2]]],
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], Assign[P3], tuple[R0, R1, R2]]:
        pass
    ...
    def __call__(
        self: AsyncMcfunction[Literal[True]],
        func: Callable[[P0, P1, P2, P3], tuple[Assign[R0], Assign[R1], Assign[R2], Assign[R3]]],
    ) -> AsyncRecursiveMcfunctionDef[Assign[P0], Assign[P1], Assign[P2], Assign[P3], tuple[R0, R1, R2, R3]]:
        pass
    ...
    def __call__(self: AsyncMcfunction, func: Callable[[*P], R]) -> AsyncMcfunctionDef[*P, R] | AsyncRecursiveMcfunctionDef[*P, R]:  # type: ignore
        ...
        if self.recursive:
            ...
            result = AsyncRecursiveMcfunctionDef(arg_types, return_types, scope, func, entry_point)
        else:
